...
class WidgetTypeParser: public TurnLeft::Utils::EnumParser<
    Enums::WidgetTypes::WidgetTypes>
{
public:
    WidgetTypeParser()
    {
    ...
    virtual Enums::WidgetTypes::WidgetTypes parse(
        const std::string& val)
    {
        std::string val_cpy = val;
        TokenGenerator tgen(val_cpy);
        return TurnLeft::Utils::EnumParser<Enums::WidgetTypes::WidgetTypes>::parse(
            tgen.next('|'));
...
class WidgetStateParser: public TurnLeft::Utils::EnumParser<
    Enums::WidgetTypes::States>
{
public:
    WidgetStateParser()
    {
