/*
 * Parseable_StaticNode.cpp
 *
 *  Created on: Sep 10, 2012
 *      Author: tom
 */

#include <Types/Parseable_StaticNode.h>
#include <Redis/RedisCore.h>

Parseable_StaticNode::Parseable_StaticNode (std::string value)
: Parseable_Tmpl <Maps::Strings> (value)
{
	interpreted = false;
}

Maps::Strings Parseable_StaticNode::interpret(uint8_t nargs, ...)
{
