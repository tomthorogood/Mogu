...
protected:
	...
	void execute(Moldable& parent);
	MoldableTemplate& __tmpl;

public:
	AbstractForEach(MoldableTemplate& __tmpl, Moldable& m);
...
class ForEachData : public AbstractForEach
{
	...
	void getNumChildren();
public:
	ForEachData(MoldableTemplate& __tmpl, Moldable& m);
};
...
class ForEachGroupMember : public AbstractForEach
{
	...
	void getNumChildren();
public:
	ForEachGroupMember(MoldableTemplate& __tmpl, Moldable& m);
};
