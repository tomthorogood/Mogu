#include <cpptest.h>
#include <src/Redis/MoguQueryHandler.h>
...
class Mogu_Query_Handler_Test : public Test::Suite
{
public:
    Mogu_Query_Handler_Test()
    {
        TEST_ADD(Mogu_Query_Handler_Test::single_response);
        TEST_ADD(Mogu_Query_Handler_Test::multi_response);
        TEST_ADD(Mogu_Query_Handler_Test::multi_flush);
        TEST_ADD(Mogu_Query_Handler_Test::map_fill);
        TEST_ADD(Mogu_Query_Handler_Test::combined_use);
        TEST_ADD(Mogu_Query_Handler_Test::multiple_handlers);
        TEST_ADD(Mogu_Query_Handler_Test::errors_handled);
        TEST_ADD(Mogu_Query_Handler_Test::set_delete_hkey);
    }
...
protected:
    virtual void setup() {
        Redis::Mogu_Query_Handler* qh = spawnHandler(); 
...
private:
    ...
    inline Redis::Mogu_Query_Handler* spawnHandler() {
        return new Redis::Mogu_Query_Handler(Prefix::meta);
    }
...
void Mogu_Query_Handler_Test::single_response()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
...
void Mogu_Query_Handler_Test::multi_response()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
...
void Mogu_Query_Handler_Test::multi_flush()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
...
void Mogu_Query_Handler_Test::combined_use()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
...
void Mogu_Query_Handler_Test::map_fill()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
...
void Mogu_Query_Handler_Test::set_delete_hkey()
{
    Redis::Mogu_Query_Handler* q {spawnHandler()};
...
void Mogu_Query_Handler_Test::multiple_handlers()
{
    Redis::Mogu_Query_Handler* qh1 = spawnHandler();
    Redis::Mogu_Query_Handler* qh2 = spawnHandler();
...
void Mogu_Query_Handler_Test::errors_handled()
{
    Redis::Mogu_Query_Handler* qh = spawnHandler();
    qh->append_query("get foo");
